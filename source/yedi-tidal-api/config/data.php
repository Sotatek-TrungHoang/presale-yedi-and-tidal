...
use App\Casts\Data\EloquentCast;
use App\Casts\Data\MoneyCast;
...
return [
     ...
     */
    'date_format' => ['Y-m-d\TH:i:s.u\Z', DATE_ATOM, 'Y-m-d', 'Y-m-d H:i:s', 'd-m-Y'],
    ...
    'casts' => [
        ...
        CarbonInterface::class => Spatie\LaravelData\Casts\DateTimeInterfaceCast::class,
        BackedEnum::class => Spatie\LaravelData\Casts\EnumCast::class,
        Model::class => EloquentCast::class,
