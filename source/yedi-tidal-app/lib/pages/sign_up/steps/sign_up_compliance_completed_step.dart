...
class SignUpComplianceCompletedStep extends StatelessWidget {
  const SignUpComplianceCompletedStep({super.key});
                ...
                builder: (context, formState) {
                  return Column(
                    children: [
                      ...
                      VSpacer(18),
                      Text(
                        "Success, your account is now fully compliant. You can now apply for Jobs with ${AppLocalizations.of(context)!.appTitle}.",
