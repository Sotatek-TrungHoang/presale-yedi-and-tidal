...
class AdvertiserSettingsContentInvoicesTab extends StatelessWidget {
  const AdvertiserSettingsContentInvoicesTab({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<ListInvoicesBloc, ListDocumentsState<InvoiceModel>>(
        ...
        switch (state.status) {
          ...
          case ListDocumentsStatus.loaded:
            ...
            return RefreshIndicator(
              onRefresh: () async => context.read<ListInvoicesBloc>().add(
              ...
              child: ListView.separated(
                ...
                itemBuilder: (context, index) {
                  ...
                  return ListTile(
                    ...
                    subtitle: Text(payslip.invoiceNumber,
