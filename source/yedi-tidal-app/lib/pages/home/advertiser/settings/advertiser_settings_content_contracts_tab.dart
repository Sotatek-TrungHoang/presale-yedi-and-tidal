...
class AdvertiserSettingsContentContractsTab extends StatelessWidget {
  const AdvertiserSettingsContentContractsTab({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<ListAdvertiserContractsBloc,
        ...
        switch (state.status) {
          ...
          case ListDocumentsStatus.loaded:
            ...
            return RefreshIndicator(
              onRefresh: () async =>
                  context.read<ListAdvertiserContractsBloc>().add(
